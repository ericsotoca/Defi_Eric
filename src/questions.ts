...
export const MILESTONE_REWARDS: { [milestone: number]: Reward } = {
  5: {
    ...
    description: "Vous venez de franchir le premier palier avec beaucoup de naturel ! Votre franchise mérite d'être honorée par une première promesse.",
    ...
    rewardText: "Promesse n°1 : Le droit absolu de choisir l'adresse de notre premier verre (je m'occupe de la réservation)."
  },
  10: {
    milestone: 10,
    title: "Le Joker 'Anti-Blanc Gênant' 🤫",
    description: "Déjà 10 questions sans faiblir ! Notre complicité commence à prendre forme. Pour assurer la suite, voici un joker indispensable.",
    image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80",
    quote: "« Le rire est le chemin le plus court entre deux personnes qui s'apprivoisent. »",
    rewardText: "Promesse n°2 : Un bon pour une anecdote insolite (ou un dossier amusant sur moi) si un silence dure plus de 10 secondes."
  },
  15: {
    milestone: 15,
    title: "Le Privilège de la Question Vérité 🗝️",
    description: "Déjà 15 questions d'une franchise absolue ! C'est l'heure d'obtenir un pouvoir exclusif pour notre rencontre.",
    image: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=800&q=80",
    quote: "« La curiosité est un joli défaut lorsqu'elle mène à une complicité sincère. »",
    rewardText: "Promesse n°3 : Le droit de me poser une question de ton choix (même très indiscrète) lors de notre rendez-vous, avec obligation d'y répondre avec une sincérité totale."
  },
  20: {
    milestone: 20,
    title: "La Promesse du Dessert Partagé (ou Volé !) 🍰",
    description: "20 paliers franchis avec succès ! Vous entrez dans le cercle très fermé des complices. Gravons cela avec gourmandise.",
    image: "https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&w=800&q=80",
    quote: "« Le bonheur ne vaut d'être vécu que s'il est partagé... surtout s'il a un goût de chocolat. »",
    rewardText: "Promesse n°4 : Le droit contractuel et absolu de piocher avec ta cuillère dans mon dessert si le tien est moins bon (ou juste par gourmandise)."
  },
  25: {
    milestone: 25,
